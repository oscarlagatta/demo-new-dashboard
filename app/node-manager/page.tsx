    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-700 font-medium">Loading system data...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Button onClick={() => window.location.reload()} className="bg-blue-800 hover:bg-blue-900 text-white">
            Retry
          </Button>
        </div>
      </div>
      ...
      <div className="bg-white border-b border-slate-200 px-4 sm:px-6 py-4 sm:py-5 shadow-sm">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-6 w-full sm:w-auto">
            <Link href="/">
              <Button variant="ghost" size="sm" className="text-slate-600 hover:text-blue-800 hover:bg-blue-50">
          ...
          <Link href="/" className="w-full sm:w-auto">
            <Button
              variant="outline"
              size="sm"
              className="border-blue-200 text-blue-800 hover:bg-blue-50 bg-transparent w-full sm:w-auto"
            >
      ...
      <div className="container mx-auto p-4 sm:p-6 max-w-7xl">
        <div className="mb-6 lg:mb-8">
          <div className="relative max-w-2xl mx-auto">
            <div className="relative group">
              <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5 text-slate-400 group-focus-within:text-blue-700 transition-colors duration-200" />
              <Input
                type="text"
                placeholder="Search nodes and connections by name, type, or classification..."
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="pl-12 pr-12 py-3 text-base border-slate-300 bg-white shadow-sm hover:shadow-md focus:shadow-md focus:border-blue-400 focus:ring-2 focus:ring-blue-100 transition-all duration-200 placeholder:text-slate-400"
              />
              {searchQuery && (
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={clearSearch}
                  className="absolute right-2 top-1/2 transform -translate-y-1/2 h-7 w-7 p-0 text-slate-400 hover:text-red-600 hover:bg-red-50 transition-colors duration-200"
                >
                  <X className="h-4 w-4" />
                </Button>
              )}
            ...
            {searchQuery && (
              <div className="mt-2 text-sm text-slate-700 font-medium animate-in fade-in-0 duration-200">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 lg:gap-0 mb-6 lg:mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
            <Button
              ...
              variant="outline"
              className="flex items-center justify-center gap-2 border-red-200 text-red-800 hover:bg-red-50 w-full sm:w-auto px-4 py-2 text-sm sm:text-base"
            >
            ...
            <Button
              ...
              className="flex items-center justify-center gap-2 bg-blue-800 hover:bg-blue-900 w-full sm:w-auto px-4 py-2 text-sm sm:text-base"
            >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-6 lg:mb-8">
          <Card className="border-blue-200 shadow-md bg-blue-50">
            <CardContent className="p-3 sm:p-4 lg:p-6">
              <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-blue-800">{activeNodes}</div>
          ...
          <Card className="border-slate-200 shadow-md bg-white">
            <CardContent className="p-3 sm:p-4 lg:p-6">
              <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-slate-700">{inactiveNodes}</div>
          ...
          <Card className="border-red-200 shadow-md bg-red-50">
            <CardContent className="p-3 sm:p-4 lg:p-6">
              <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-red-800">{totalConnections}</div>
              <div className="text-xs sm:text-sm text-red-700 font-medium mt-1">
          ...
          <Card className="border-blue-200 shadow-md bg-blue-50">
            <CardContent className="p-3 sm:p-4 lg:p-6">
              <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-blue-800">{backgroundNodes.length}</div>
              <div className="text-xs sm:text-sm text-blue-700 font-medium mt-1">
        ...
        <Tabs defaultValue="nodes" className="w-full">
          <TabsList className="grid w-full grid-cols-2 bg-slate-100 border border-slate-200">
            <TabsTrigger
              value="nodes"
              className="data-[state=active]:bg-blue-50 data-[state=active]:text-blue-900 data-[state=active]:border-blue-200 text-sm sm:text-base"
            >
            ...
            <TabsTrigger
              value="connections"
              className="data-[state=active]:bg-red-50 data-[state=active]:text-red-900 data-[state=active]:border-red-200 text-sm sm:text-base"
            >
              <span className="hidden sm:inline">
                      ...
                      <div className="flex justify-between items-start">
                        ...
                        <div className="flex gap-1 ml-2">
                          ...
                          <Button
                            ...
                            className="h-7 w-7 sm:h-8 sm:w-8 p-0 text-slate-500 hover:text-red-700 hover:bg-red-50"
                          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
              {filteredEdges.map((edge) => {
                ...
                return (
                  <Card
                    key={edge.id}
                    className="shadow-md hover:shadow-lg transition-shadow border-slate-200 bg-white hover:border-red-200"
                  >
                      ...
                      <div className="flex justify-between items-start gap-3">
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 text-xs sm:text-sm">
                            ...
                            <span className="text-red-400 self-start sm:self-center">→</span>
                            <span className="font-semibold text-slate-900 truncate">
                        ...
                        <Button
                          ...
                          className="h-7 w-7 sm:h-8 sm:w-8 p-0 text-slate-500 hover:text-red-700 hover:bg-red-50 flex-shrink-0"
                        >
                          <Trash2 className="h-3 w-3 sm:h-4 sm:w-4" />
                        </Button>
                      </div>
