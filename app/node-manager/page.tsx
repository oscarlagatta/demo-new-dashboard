  ...
  return (
    <div className="container mx-auto p-6 max-w-6xl">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Node Manager</h1>
          <p className="text-gray-600 mt-2">Manage payment processing system nodes and their configurations</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <Card>
          <CardContent className="p-4">
            <div className="text-2xl font-bold text-green-600">{nodes.filter((n) => n.status === "active").length}</div>
            <div className="text-sm text-gray-600">Active Nodes</div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <div className="text-2xl font-bold text-red-600">{nodes.filter((n) => n.status === "inactive").length}</div>
